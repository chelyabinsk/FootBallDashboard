...
#    stop_season = '2015-2016'
    ...
    return big_df.sort_values('Date',ascending=False)
...
#        
#        max_games = head_to_head_data.shape[0]
#        if variant_filter_decision:
#            # Find the number of available games
#            #st.write('Games played',head_to_head_data.shape[0])
#            
#            nums = []
#            for j in np.linspace(1,max_games,max_games):
#                for i in range(int(j),max_games+1):                
#                    nums.append("{}/{}".format(int(j),int(i)))
##            st.write(nums)
#            # Gen list
...
#                        )
#            
#            tmp = variant_filter.split('/')
#            chosen_games_min = int(tmp[0])
#            chosen_games_n = int(tmp[1])
#            
#            head_to_head_data = head_to_head_data.head(chosen_games_n)
...
#    st.write("### Raw data", head_to_head_data.sort_values('Date',ascending=False))
